...
public class SwapTwoNumbers {
	...
	public static void main(String[] args) {
		...
		System.out.println("Before swapping numbers : " + " " + "Number One : " + firstNumber + " " + "Number Two : "
				+ " " + secondNumber);
		firstNumber += secondNumber;
		secondNumber = firstNumber - secondNumber;
		firstNumber = firstNumber - secondNumber;
		System.out.println("After swapping numbers : " + " " + "Number One : " + firstNumber + " " + "Number Two : "
				+ " " + secondNumber);
	}
